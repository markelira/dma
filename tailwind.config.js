...
module.exports = {
  ...
  theme: {
    container: {
      ...
      padding: "2rem",
      screens: {
        "lg": "1320px", // DMA custom layout width
        "2xl": "1400px",
      },
    },
    extend: {
      screens: {
        '3xl': '2400px',  // Ultra-wide displays (21:9 monitors at 3440px)
      },
      fontFamily: {
      ...
      colors: {
        ...
        // Academic Harvard/Yale Color Scheme - Full palette from DMA
        academic: {
          primary: {
            50: '#FFFBEB',
            100: '#FEF3C7',
