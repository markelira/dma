...
Consistent spacing is critical for a clean, readable, and maintainable UI. DMA uses a 4-based spacing scale, available as both CSS variables and Tailwind utilities.
