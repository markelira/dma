    ...
    <div className="space-y-8">
      ...
      <section className="bg-white rounded-lg shadow-sm p-6">
        <div className="flex items-center gap-2 mb-6">
          ...
          <h2 className="text-xl font-bold">Kiemelések</h2>
        </div>
      ...
      <section className="bg-white rounded-lg shadow-sm p-6">
        <div className="flex items-center gap-2 mb-6">
          ...
          <h2 className="text-xl font-bold">Tartalom statisztikák</h2>
        </div>
      ...
      <section className="bg-white rounded-lg shadow-sm p-6">
        <h2 className="text-xl font-bold mb-6">Amit mások mondanak</h2>
