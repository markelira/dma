    ...
    <>
      ...
      >
        <Image
          ...
          src="/images/landing/stripes.svg"
          width={768}
          height={432}
          alt="Stripes"
          priority
      ...
      <div
        ...
        aria-hidden="true"
      >
        <div className="h-80 w-80 rounded-full bg-gradient-to-tr from-brand-secondary/50 opacity-50 blur-[160px]" />
      </div>
      <div
        className="pointer-events-none absolute left-1/2 top-[420px] ml-[380px] -translate-x-1/2"
        aria-hidden="true"
      >
        <div className="h-80 w-80 rounded-full bg-gradient-to-tr from-brand-secondary/50 to-gray-900 opacity-50 blur-[160px]" />
      </div>
      <div
