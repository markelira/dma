...
const navigation = {
  ...
  social: [
    {
      name: "Facebook",
      href: "https://facebook.com/dma",
      icon: Facebook,
    },
    {
      name: "LinkedIn",
      href: "https://linkedin.com/company/dma",
      icon: Linkedin,
    },
    {
      name: "YouTube",
      href: "https://youtube.com/@dma",
      icon: Youtube,
    },
    {
      name: "Instagram",
      href: "https://instagram.com/dma",
      icon: Instagram,
    },
  ],
}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">info@dma.hu</p>
              </div>
            </div>
            <div className="flex items-center space-x-3">
