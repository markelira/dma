    ...
    <div className="mb-12 md:mb-16">
      ...
      <div className="relative group/nav">
        ...
        {canScrollLeft && (
          <button
            onClick={() => scroll('left')}
            className="absolute -left-4 md:-left-5 top-1/2 -translate-y-1/2 z-20 w-10 h-10 md:w-12 md:h-12 rounded-full bg-white shadow-lg border border-gray-100 flex items-center justify-center opacity-0 group-hover/nav:opacity-100 transition-all duration-200 hover:bg-gray-50 hover:scale-105"
        ...
        {canScrollRight && (
          <button
            ...
            className="absolute -right-4 md:-right-5 top-1/2 -translate-y-1/2 z-20 w-10 h-10 md:w-12 md:h-12 rounded-full bg-white shadow-lg border border-gray-100 flex items-center justify-center opacity-0 group-hover/nav:opacity-100 transition-all duration-200 hover:bg-gray-50 hover:scale-105"
