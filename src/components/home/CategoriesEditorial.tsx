        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 md:gap-5">
          {categories.map((category) => (
            <Link
              ...
              className="group"
            >
              <div className="h-full bg-white rounded-2xl p-6 md:p-8 border border-gray-100 shadow-sm transition-all duration-300 hover:border-[#E72B36]/30 hover:shadow-lg hover:scale-[1.02] flex flex-col items-center text-center min-h-[180px] md:min-h-[200px]">
                <div className="w-14 h-14 md:w-16 md:h-16 rounded-xl bg-gray-100 flex items-center justify-center mb-4 group-hover:bg-[#E72B36]/10 transition-colors">
                  <category.Icon className="w-7 h-7 md:w-8 md:h-8 text-gray-600 group-hover:text-[#E72B36] transition-colors" />
                </div>
                <h3 className="text-base md:text-lg font-semibold text-gray-900 group-hover:text-[#E72B36] transition-colors leading-tight">
                  {category.title}
                </h3>
              </div>
            </Link>
