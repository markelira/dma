      ...
      >
        ...
        <div className="relative group px-6 md:px-8 py-6">
          ...
          <div
            ...
            className="flex gap-5 overflow-x-auto overflow-y-visible py-3 pl-4 scrollbar-hide scroll-smooth"
            style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}
          >
            {courses.map((course, index) => (
              <div key={course.id} className="flex-shrink-0 w-[280px] md:w-[320px] h-[360px]">
                <PremiumCourseCard
                  course={course}
                  index={index}
