  ...
  if (user?.role === 'ADMIN' || user?.role === 'COMPANY_ADMIN') {
    return (
      <div className="flex min-h-screen items-center justify-center bg-gray-50">
        <Loader2 className="h-16 w-16 animate-spin text-white0" />
      </div>
    );
  }
    ...
    <>
      ...
      <div className="space-y-8">
        ...
        {isCompanyEmployee && companyInfo && (
          <div className="rounded-xl bg-gradient-to-r from-brand-secondary/5/80 to-purple-50/80 border border-brand-secondary/20/50 p-4">
            <div className="flex items-center space-x-3">
              <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-brand-secondary/50 to-purple-600 flex items-center justify-center shadow-lg flex-shrink-0">
              ...
              <span className="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-normal bg-brand-secondary/10 text-brand-secondary-hover">
