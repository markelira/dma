                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-right">
                        {invoice.invoicePdfUrl ? (
                          <button
                            ...
                            className="inline-flex items-center px-3 py-1.5 border border-gray-300 text-sm rounded-lg text-gray-700 bg-white hover:bg-blue-50 hover:text-blue-700 hover:border-blue-300 transition-colors"
                          >
