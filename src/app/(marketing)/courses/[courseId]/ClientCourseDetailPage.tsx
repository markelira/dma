  ...
  return (
    <AuthProvider>
      ...
      <div className="min-h-screen bg-gray-950">
        ...
        {/* Main Content */}
        <div ref={detailsRef} className="w-full mx-auto max-w-[1440px] 2xl:max-w-[1800px] px-4 sm:px-5 md:px-6 lg:px-12 xl:px-20 2xl:px-24 py-8 sm:py-10 lg:py-12">
        ...
        {relatedCourses.length > 0 && (
          <div className="w-full mx-auto max-w-[1440px] 2xl:max-w-[1800px] px-4 sm:px-5 md:px-6 lg:px-12 xl:px-20 2xl:px-24 pb-8 sm:pb-10 lg:pb-12">
