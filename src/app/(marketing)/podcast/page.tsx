          ...
          <div className="flex items-center justify-end">
            <div className="relative w-[300px]">
              <input
                ...
                placeholder="Keresés podcastok között..."
          ...
          {isSearching ? (
            ...
            <>
              ...
              {popularCourses.length > 0 && (
                <section>
                  <h2 className="text-2xl font-bold text-white mb-6">Felkapott Podcastok</h2>
                  <motion.div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6" initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              {newestCourses.length > 0 && (
                <section>
                  <h2 className="text-2xl font-bold text-white mb-6">Legújabb Podcastok</h2>
                  <motion.div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6" initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
