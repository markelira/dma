...
export default function PodcastPage() {
  ...
  if (loading) {
    return (
      <AuthProvider>
        <FramerNavbarWrapper />
        <div className="min-h-screen bg-gradient-to-br from-green-50 via-blue-50/30 to-gray-50 flex items-center justify-center">
  ...
  return (
    <AuthProvider>
      ...
      <div className="min-h-screen bg-gradient-to-br from-green-50 via-blue-50/30 to-gray-50 relative overflow-hidden">
