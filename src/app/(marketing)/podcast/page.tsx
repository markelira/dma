...
export default function PodcastPage() {
  ...
  if (loading) {
    return (
      <AuthProvider>
        <FramerNavbarWrapper />
        <div className="min-h-screen bg-gradient-to-br from-green-50 via-brand-secondary/5/30 to-gray-50 flex items-center justify-center">
          <div className="text-center">
            <div className="animate-spin rounded-full h-16 w-16 mx-auto mb-6 border-4 border-gray-200 border-t-green-600" />
            <p className="text-lg text-gray-600">Podcastok betöltése...</p>
          </div>
        </div>
        <Footer border={true} />
      </AuthProvider>
  ...
  return (
    <AuthProvider>
      ...
      <div className="min-h-screen bg-gradient-to-br from-green-50 via-brand-secondary/5/30 to-gray-50 relative overflow-hidden">
        {/* Background blur shapes */}
        <div className="pointer-events-none absolute top-0 right-0 w-96 h-96 bg-green-100/30 rounded-full blur-3xl" aria-hidden="true"></div>
          ...
          <div className="container mx-auto max-w-6xl text-center">
            ...
            >
              ...
              <p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto">
                Podcast epizódok audio- vagy videótartalommal. Beszélgetések, interjúk és inspiráló tartalmak szakértőkkel.
              </p>
            </motion.div>
            ...
            >
              <div className="relative">
                <input
                  type="text"
                  placeholder="Keress podcastok között..."
                  value={searchInput}
                  onChange={(e) => setSearchInput(e.target.value)}
                  className="w-full px-6 py-4 rounded-full border-2 border-white/50 bg-white/60 backdrop-blur-xl shadow-lg focus:outline-none focus:border-green-500 transition-all text-gray-900 placeholder-gray-500"
                />
              </div>
            </motion.div>
          </div>
              ...
              {filteredCourses.length === 0 ? (
                ...
                >
                  ...
                  <button
                    ...
                    className="btn bg-gradient-to-t from-green-600 to-green-500 text-white shadow-sm hover:shadow-md transition-all"
                  >
                    Szűrők törlése
                  </button>
                </motion.div>
