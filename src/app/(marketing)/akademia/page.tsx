          ...
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="relative w-[300px]">
              <input
                ...
                placeholder="Keresés..."
                className="w-full px-4 py-2 bg-gray-800 border border-gray-700 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:border-brand-secondary text-sm"
              />
            </div>
          </div>
          ...
          {filteredCourses.length === 0 && !featuredCourse ? (
            ...
            >
              ...
              <p className="text-gray-400 text-center max-w-md">
                Hamarosan érkeznek új akadémia tartalmak
              </p>
            </motion.div>
          ) : (
            <motion.div
