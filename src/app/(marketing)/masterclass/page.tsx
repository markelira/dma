...
export default function MasterclassPage() {
  ...
  return (
    <AuthProvider>
      ...
      <div className="min-h-screen bg-gradient-to-br from-amber-50 via-yellow-50/30 to-gray-50 relative overflow-hidden">
        {/* Background blur shapes */}
        <div className="pointer-events-none absolute top-0 right-0 w-96 h-96 bg-amber-100/30 rounded-full blur-3xl" aria-hidden="true"></div>
        <div className="pointer-events-none absolute bottom-0 left-0 w-64 h-64 bg-yellow-100/20 rounded-full blur-2xl" aria-hidden="true"></div>
              ...
              {filteredCourses.length === 0 ? (
                ...
                >
                  ...
                  <button
                    ...
                    className="btn bg-gradient-to-t from-amber-600 to-amber-500 text-white shadow-sm hover:shadow-md transition-all"
                  >
                    Szűrők törlése
                  </button>
                </motion.div>
