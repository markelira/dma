...
/**
 * Company Vezerlopult (Control Panel) Page
 *
 * Company management features: stats, subscription, employees, courses
 */
export default function CompanyVezerlopultPage() {
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-600">
          Kezeld a vállalat munkatársait és kövesd a tanulási előrehaladást
        </p>
      </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-600 mt-1">
                  Az előfizetéssel korlátlan hozzáférést biztosíthatsz az összes tartalomhoz minden munkatársad számára.
                </p>
      ...
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          >
            ...
            <div>
              <p className="font-medium text-gray-900">Munkatárs hozzáadása</p>
      ...
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
        ...
        {enrolledCoursesLoading ? (
          ...
          <div className="text-center py-8">
            ...
            <p className="text-sm text-gray-500 mt-1">Adj hozzá tartalmakat, hogy a munkatársak elkezdhenek tanulni.</p>
          </div>
        ) : (
            ...
            >
              <div className="p-6 border-b border-gray-200">
                ...
                <p className="text-sm text-gray-500 mt-1">
                  Válassz ki egy tartalmat, amelyre be szeretnéd iratkoztatni a munkatársakat.
                </p>
              </div>
