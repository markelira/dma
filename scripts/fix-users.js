...
async function listAndFixUsers() {
  ...
  try {
    ...
    console.log('   Authentication: https://console.firebase.google.com/project/dmaapp-477d4/authentication/users');
    console.log('   Firestore Users: https://console.firebase.google.com/project/dmaapp-477d4/firestore/data/~2Fusers');
