...
async function handleCompanySubscription(params) {
    ...
    try {
        ...
        v2_1.logger.info('[handleCompanySubscription] Company subscription created', {
            userId,
            companyId,
            subscriptionId,
            status: subscriptionStatus,
 ...
 */
async function updateCompanySubscription(stripeSubscriptionId, status, endDate) {
    try {
        ...
        v2_1.logger.info('[updateCompanySubscription] Company subscription updated', {
        ...
        v2_1.logger.error('[updateCompanySubscription] Error:', error);
    }
}
/**
        ...
        if (subscription.status === 'active') {
            ...
            if (!subscriptionsSnapshot.empty) {
                ...
                if (subscriptionData.userId) {
                    ...
                    v2_1.logger.info('[handleInvoicePaymentSucceeded] User subscriptionStatus updated to active', {
...
async function handleInvoicePaymentFailed(invoice) {
    try {
        ...
        await (0, createTeam_1.updateTeamSubscription)(subscriptionId, 'past_due');
        // 2. Update company subscription (B2B)
        ...
        if (!subscriptionsSnapshot.empty) {
            ...
            if (subscriptionData.userId) {
                ...
                v2_1.logger.info('[handleInvoicePaymentFailed] User subscriptionStatus updated to past_due', {
                    userId: subscriptionData.userId,
                });
            }
        }
