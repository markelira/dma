...
exports.validatePromoCode = exports.deletePromoCode = exports.getPromoCodes = exports.createPromoCode = void 0;
/**
...
exports.createPromoCode = (0, https_1.onCall)({
    ...
    try {
        ...
        v2_1.logger.info(`Promo code created: ${upperCode} by ${userId}`);
        return {
            success: true,
        ...
        v2_1.logger.error('Create promo code error:', error);
...
exports.getPromoCodes = (0, https_1.onCall)({
    ...
    try {
        ...
        v2_1.logger.error('Get promo codes error:', error);
...
exports.deletePromoCode = (0, https_1.onCall)({
    ...
    try {
        ...
        v2_1.logger.info(`Promo code deleted: ${promoCodeId} by ${userId}`);
        return {
            success: true,
        ...
        v2_1.logger.error('Delete promo code error:', error);
...
exports.validatePromoCode = (0, https_1.onCall)({
    ...
    try {
        ...
        v2_1.logger.error('Validate promo code error:', error);
