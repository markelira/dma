...
exports.markAchievementCelebrated = exports.checkAchievements = exports.getAllAchievements = exports.getUserAchievements = void 0;
/**
 ...
 */
exports.getUserAchievements = (0, https_1.onCall)({
    cors: true,
    region: 'us-central1',
}, async (request) => {
    try {
 ...
 */
exports.getAllAchievements = (0, https_1.onCall)({
    cors: true,
    region: 'us-central1',
}, async (request) => {
    try {
        ...
        const userAchievementsSnapshot = await firestore
            ...
            .where('userId', '==', userId)
            .get();
        const unlockedIds = new Set(userAchievementsSnapshot.docs.map(doc => doc.data().achievementId));
        // Combine with definitions
        const allAchievements = ACHIEVEMENT_DEFINITIONS.map(def => {
            const userAchievement = userAchievementsSnapshot.docs.find(doc => doc.data().achievementId === def.id);
            if (userAchievement) {
 ...
 */
exports.checkAchievements = (0, https_1.onCall)({
    cors: true,
    region: 'us-central1',
}, async (request) => {
    try {
 ...
 */
exports.markAchievementCelebrated = (0, https_1.onCall)({
    cors: true,
    region: 'us-central1',
}, async (request) => {
    try {
 ...
 */
function shouldUnlockAchievement(definition, stats, eventType, metadata) {
    ...
    switch (type) {
        ...
        case 'course_complete_days':
            return (eventType === 'course_complete' &&
